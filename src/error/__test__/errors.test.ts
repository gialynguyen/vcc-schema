...
import { InvalidTypeError, InvalidUnionTypeError, TooSmallError, TooBigError, IncorrectSizeError, NoEqualError, InvalidFieldError, InvalidStringFormat } from "../errors";

describe("Error Errors", () => {
    describe("InvalidTypeError", () => {
        it("Should have instance of InvalidTypeError", () => {
            InvalidTypeError.setDefaultMessage = "Set the default message from outside";
            ...
            expect(subject.error.message).toEqual("Set the default message from outside");
        });
    ...
    describe("InvalidUnionTypeError", () => {
        ...
        it("Should have instance of InvalidUnionTypeError", () => {
            InvalidUnionTypeError.setDefaultMessage = "Set the default message from outside";
        ...
        describe("Without default message", () => {
            const subject = new InvalidUnionTypeError({ expectedType, receivedType });
            expect(subject.error.message).toEqual(`Expected ${InvalidUnionTypeError.joinExpectedType(expectedType)}, received ${receivedType}`);
        });

        describe("With default message", () => {
            const message = "The value must be of type string and number";
            const subject = new InvalidUnionTypeError({ expectedType, receivedType, message });
    ...
    describe("TooSmallError", () => {
        ...
        describe("Without default message", () => {
            const subject = new TooSmallError({ expectedSize, receivedSize });
            expect(subject.error.message).toEqual(`Length must be greater than ${expectedSize}, but received ${receivedSize}`);
        });

        describe("With default message", () => {
            const message = `The value must be equal to or greater than ${expectedSize}`;
            const subject = new TooSmallError({ expectedSize, receivedSize, message });
            expect(subject.error.message).toEqual(message);
        });
    });
    ...
    describe("TooBigError", () => {
        ...
        describe("Without default message", () => {
            const subject = new TooBigError({ expectedSize, receivedSize });
            expect(subject.error.message).toEqual(`Length must be less than ${expectedSize}, but received ${receivedSize}`);
        });
    ...
    describe("IncorrectSizeError", () => {
        ...
        it("Should have instance of IncorrectSizeError", () => {
            IncorrectSizeError.setDefaultMessage = "Set the default message from outside";
        ...
        describe("Without default message", () => {
            const subject = new IncorrectSizeError({ expectedSize, receivedSize });
            expect(subject.error.message).toEqual(`Length must be equal ${expectedSize}, but received ${receivedSize}`);
        });

        describe("With default message", () => {
            const message = `The value must be equal to ${expectedSize}`;
            const subject = new IncorrectSizeError({ expectedSize, receivedSize, message });
            expect(subject.error.message).toEqual(message);
        });
    });
    ...
    describe("NoEqualError", () => {
        ...
        describe("Without default message", () => {
            const subject = new NoEqualError({ expectedValue, receivedValue });
            expect(subject.error.message).toEqual(`Value must be equal ${expectedValue}, but received ${receivedValue}`);
        });

        describe("With default message", () => {
            const message = `The value must be equal to ${expectedValue}`;
            const subject = new NoEqualError({ expectedValue, receivedValue, message });
            expect(subject.error.message).toEqual(message);
        });
    });
    ...
    describe("InvalidFieldError", () => {
        ...
        it("Should have instance of InvalidFieldError", () => {
            InvalidFieldError.setDefaultMessage = "Set the default message from outside";
        ...
        describe("Without default message", () => {
            ...
            expect(subject.error.message).toEqual(`${invalidFieldPaths} is an invalid field`);
        });

        describe("With default message", () => {
            const message = `Invalid field at property ${invalidFieldPaths}`;
            const subject = new InvalidFieldError({ paths, invalidFieldPaths, message });
            expect(subject.error.message).toEqual(message);
        });
    });
    ...
    describe("InvalidStringFormat", () => {
        ...
        it("Should have instance of InvalidStringFormat", () => {
            InvalidStringFormat.setDefaultMessage = "Set the default message from outside";
        ...
        describe("Without default message", () => {
            const subject = new InvalidStringFormat({ receivedString });
            expect(subject.error.message).toEqual(`${receivedString} is not a valid email`);
        });
