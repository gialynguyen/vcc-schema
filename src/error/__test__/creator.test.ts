...
describe("Error Creator", () => {
    ...
    describe("ErrorSet", () => {
        ...
        it('Should have instance of ErrorSet', () => {
            ...
            expect(subject.message).toEqual(`1 issue(s) has found\n\n   Error 1: invalid_type \n   Invalid Type\n`);

            subject.addErrors();
            expect(subject.errors.length).toBe(1);

            subject.addErrors([new ErrorSubject({
                code: 'no_empty',
                message: 'No Empty',
        ...
        it('Should constructuring without Object\'s setPrototypeOf', () => {
            Object.defineProperty(Object, 'setPrototypeOf', { writable: true, value: null });
            const subject = new ErrorSet([]);
